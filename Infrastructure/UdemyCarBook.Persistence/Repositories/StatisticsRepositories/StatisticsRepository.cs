...
namespace UdemyCarBook.Persistence.Repositories.StatisticsRepositories
{
    public class StatisticsRepository : IStatisticsRepository
    {
        ...
        public string GetBrandAndModelByRentPriceMax()
        {
            ...
            string brandModel = _context.Cars.Where(x => x.CarID == carID).Include(y => y.Name).Select(z => z.Name.Name + " " + z.Model).FirstOrDefault();
            return brandModel;
        }
        ...
        public string GetBrandNameByMaxCar()
        {
            ...
            //burada yakaladığımız id'ye göre marka adını aldık
